...
class AppColor {
  ...
  static Color get secondary => const Color(0xFF1A3129);
  ...
  static Color get surfaceColor => const Color(0xFF1A3129); //bottom naviagation bar
  static Color get outlineColor => const Color(0xFF1A3129); 
