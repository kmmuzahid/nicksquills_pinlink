...
import 'package:pinlink/coreFeature/auth/screens/change_password_screen.dart'
    as _i3;
import 'package:pinlink/coreFeature/auth/screens/login_screen.dart' as _i8;
import 'package:pinlink/coreFeature/auth/screens/reset_password_screen.dart'
    as _i15;
import 'package:pinlink/coreFeature/auth/screens/send_otp_screen.dart' as _i16;
import 'package:pinlink/coreFeature/faq/screens/faq_screen.dart' as _i6;
...
import 'package:pinlink/coreFeature/notification/notification_screen.dart'
    as _i10;
import 'package:pinlink/coreFeature/onboarding/onboarding_screen.dart' as _i11;
import 'package:pinlink/coreFeature/profile/screens/personal_information_screen.dart'
    as _i12;
import 'package:pinlink/coreFeature/splash/splash_screen.dart' as _i17;
import 'package:pinlink/coreFeature/terms/privacy_policy_screen.dart' as _i14;
import 'package:pinlink/coreFeature/terms/terms_of_use_screen.dart' as _i19;
...
import 'package:pinlink/features/leaderboard/screens/add_friend_screen.dart'
    as _i7;
import 'package:pinlink/features/social/screens/create_post_screen.dart' as _i5;
...
/// generated route for
/// [_i2.AddCourseScreen]
class AddCourseRoute extends _i20.PageRouteInfo<AddCourseRouteArgs> {
  AddCourseRoute({
    _i21.Key? key,
...
class ComparisonRoute extends _i20.PageRouteInfo<ComparisonRouteArgs> {
  ComparisonRoute({
    _i21.Key? key,
    required _i22.AddCourseCubit cubit,
...
class ComparisonRouteArgs {
  ...
  final _i22.AddCourseCubit cubit;
...
class CreatePostRoute extends _i20.PageRouteInfo<void> {
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    name,
    builder: (data) {
      return const _i5.CreatePostScreen();
    },
  );
}
...
class FaqRoute extends _i20.PageRouteInfo<void> {
  const FaqRoute({List<_i20.PageRouteInfo>? children})
...
class NavigationRoute extends _i20.PageRouteInfo<void> {
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    name,
    builder: (data) {
      return const _i9.NavigationScreen();
    },
  );
}
...
/// generated route for
/// [_i12.PersonalInformationScreen]
class PersonalInformationRoute extends _i20.PageRouteInfo<void> {
  const PersonalInformationRoute({List<_i20.PageRouteInfo>? children})
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    name,
    builder: (data) {
      return const _i12.PersonalInformationScreen();
    },
  );
}

/// generated route for
/// [_i13.PostDetailsScreen]
class PostDetailsRoute extends _i20.PageRouteInfo<void> {
  const PostDetailsRoute({List<_i20.PageRouteInfo>? children})
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    name,
    builder: (data) {
      return const _i13.PostDetailsScreen();
    },
  );
}
...
class ResetPasswordRoute extends _i20.PageRouteInfo<ResetPasswordRouteArgs> {
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    ...
    builder: (data) {
      ...
      return _i15.ResetPasswordScreen(
        key: args.key,
...
/// generated route for
/// [_i16.SendOtpScreen]
class SendOtpRoute extends _i20.PageRouteInfo<SendOtpRouteArgs> {
  SendOtpRoute({
    _i21.Key? key,
...
class SubscriptionsRoute extends _i20.PageRouteInfo<SubscriptionsRouteArgs> {
  SubscriptionsRoute({
    _i21.Key? key,
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    ...
    builder: (data) {
      ...
      return _i18.SubscriptionsScreen(
        key: args.key,
...
/// generated route for
/// [_i19.TermsOfUseScreen]
class TermsOfUseRoute extends _i20.PageRouteInfo<void> {
  const TermsOfUseRoute({List<_i20.PageRouteInfo>? children})
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    name,
    builder: (data) {
      return const _i19.TermsOfUseScreen();
    },
  );
}
