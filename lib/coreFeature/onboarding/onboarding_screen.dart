      ...
      children: List.generate(pages.length, (index) {
        return Container(
          ...
          decoration: BoxDecoration(
            border: Border.all(color: AppColor.tEXT_white, width: 1.5),
            borderRadius: BorderRadius.circular(15),
            color: pageIndex == index ? AppColor.pRIMARY_brandClr : AppColor.tEXT_white,
          ),
        );
      }),
    );
            ...
            child: Column(
              ...
              children: [
                ...
                CommonText(
                  ...
                  textColor: AppColor.bACKGROUND_clickableBorder,
                  maxLines: 3,
                ),
                const Spacer(),
                _pageIndicator(),
